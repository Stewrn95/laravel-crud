                ...
                <div class="card-body">
                    ...
                    <form action="/products/store" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" style="resize:none; height: 150px;" class="form-control @if($errors->has('description')) is-invalid @endif" placeholder="Enter the description of the product">{{ old('description') }}</textarea>
